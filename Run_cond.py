...
def main():
    ...
    # load torch
    weights_path = os.path.abspath(os.path.dirname(__file__)) + '/weights_center_cond_l1' #/weights_group
    
    model_lst = [x for x in sorted(os.listdir(weights_path)) if x.endswith('.pkl')]

    weight_abs_path='weights_center_cond_l1/epoch_100.pkl' #my weigh_path
    ...
    for img_id in ids:
        ...
        for detectionid, detection in enumerate(detections):
            ...
            [orient, conf, dim, _] = model(input_tensor)
        ...
        if not FLAGS.hide_debug:
            ...
            print('-------------')
            print(img_id)
        result_path='./100epoch_center_cond_0411/'
