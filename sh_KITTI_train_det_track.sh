...
W_PATH=$W_PATH"/DET_TRK_KITTI_"
R_PATH=$R_PATH"/DET_TRK_KITTI_"
...
python KITTI_train_det_track.py -T=$TYPE -W_PATH=$W_PATH -D=$DEVICE -E=$EPOCH -B=$BIN -G=$GROUP -W=$WARMUP -C=$COND -N=$NETWORK -DEP=$DEPTH -A=$AUGMENT 
